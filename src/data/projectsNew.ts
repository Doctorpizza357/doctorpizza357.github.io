...
export const projects: ProjectData[] = [
  // ─── 1. RC Vehicle (Flagship) ────────────────────────────────────────────────
  {
    ...
    caseStudySections: [
      ...
      { key: 'iteration', heading: 'Design Iteration', body: 'Version 01 established the basic proportions and proved the parametric approach worked. Version 02 revised the suspension pickup points after analysis showed excessive camber gain, and shortened the wheelbase by 8mm for better cornering response. Version 03 refined manufacturing considerations — adding draft angles for moldability and reducing part count by combining brackets.', media: [
        { type: 'cad-render', src: '/assets/img/rc-vehicle-v1.png', alt: 'Version 01 of the RC vehicle design', caption: 'Version 01 — initial concept' },
        { type: 'cad-render', src: '/assets/img/rc-vehicle-v2.png', alt: 'Version 02 with revised suspension pickup points', caption: 'Version 02 — suspension revision' },
        { type: 'cad-render', src: '/assets/img/rc-vehicle-v3.png', alt: 'Version 03 of the RC vehicle final design', caption: 'Version 03 — final design' },
      ] },
